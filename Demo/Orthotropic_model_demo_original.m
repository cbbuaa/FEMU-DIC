...
%
% Model exported on Jan 12 2024, 00:20 by COMSOL 6.1.0.346.
...
model.param.set('Ex', '13.9e9', 'Ex');
model.param.set('Ey', '5e9', 'Ey');
model.param.set('vxy', '0.1', 'vxy');
model.param.set('Gxy', '2e9', 'Shear modulus');
model.param.set('R', '1.65 [mm]', 'Radius');
model.param.set('theta', '7*pi/12', 'Angle');
model.param.set('L', '17 [mm]', 'Length');
...
model.component('comp1').view('view1').axis.set('xmin', -11.4858980178833);
model.component('comp1').view('view1').axis.set('xmax', 11.4858980178833);
model.component('comp1').view('view1').axis.set('ymin', -9.851283073425293);
model.component('comp1').view('view1').axis.set('ymax', 9.851283073425293);
...
model.result.export('data1').set('filename', '/Users/binchen/Desktop/FEMU Open/Virtual_image_generate/FEA_results/Strain.csv');
...
model.result.export('data2').set('filename', '/Users/binchen/Desktop/FEMU Open/Virtual_image_generate/FEA_results/Disp.csv');
